  ...
  const headers2 = { 
    ...
    var resp = axios.put(`https://ac0fw2o8w7.execute-api.us-east-1.amazonaws.com/prod/upload/sagemakerretrieve/${selectedFile.name}`,fd, {"x-amz-meta-customLabels" : selectedData.phone}).then((response) => {
    ...
    console.log("2222",ph)
    var ph = selectedData
    axios.post(`https://ac0fw2o8w7.execute-api.us-east-1.amazonaws.com/prod/uploadnumber`,ph, {headers2}).then((response2) => {
            console.log(response2);
          });
    console.log("mobilenoooo",selectedData)

    axios.post(`https://145gkmq34e.execute-api.us-east-1.amazonaws.com/prod/sendreporttowauser`,ph, {headers2}).then((response2) => {
            console.log(response2);
          });
  ...
  const handleSubmission2 = (e) => {
    ...
    axios.post(`https://145gkmq34e.execute-api.us-east-1.amazonaws.com/prod/sendreporttowauser`,mobile, {headers3}).then((response2) => {
            console.log(response2);
          });
